package com.hft.sparkproject.util;
...
public class ValidUtils {
     ...
     * @return 校验结果
     */
    public static boolean between(String data, String dataField, String parameter,
        ...
        String dataFieldStr = StringUtils.getFieldFromConcatString(data,
                "\\|", dataField);
        if(dataFieldStr != null){
            int dataFieldValue = Integer.valueOf(dataFieldStr);
            return dataFieldValue >= startParamFieldValue &&
    ...
    public static boolean equal(String data, String dataField, String parameter, String paramField){
        ...
        String dataFieldValue = StringUtils.getFieldFromConcatString(parameter, "\\|", dataField);
        if(dataFieldValue != null){
